...
from model_blocks import single_tree_condensation_block
...
def config_model(Inputs, td, debug_outdir=None, plot_debug_every=PLOT_FREQUENCY, 
    ...
    out, graph, sels = single_tree_condensation_block(pre_processed,
...
train.saveModel(os.path.join(train.outputDir, 'saved_model.h5'))
